...
type ImageTask struct{
	Image 		*Image
	Effects 	[]string	//The effects to be applied to this image in this given task
	OutPath 	string		//The path to write to when all effects are applied and task is done
}
